...
namespace QuantLib {
    ...
    class ModTripleBandLinearOp : public TripleBandLinearOp {
      public:
        ...
        boost::shared_array<Real>& diag()  { return diag_; }
        boost::shared_array<Real>& upper() { return upper_; }

		// modified for XFG3 LSV implementation illustration
		boost::shared_array<Size>& i0() { return i0_; }
		boost::shared_array<Size>& i2() { return i2_; }
    };
}
